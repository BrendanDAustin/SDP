...
class Matrix():
    ...
    def __init__(self):
        ...
        self.LED_VALUE_MATRIX_INDICES = {'top_1':(0,slice(4,9)),
                                ...
                                'top_3':(2,slice(4,9)),
                                'top_4':(3,slice(4,9)),
                                'bottom_1':(4,slice(4,9)),
                                'bottom_2':(5,slice(4,9)),
                                'bottom_3':(6,slice(4,9)),
                                'bottom_4':(7,slice(4,9)),
                                'top_5':(0,slice(9,14)),
                                'top_6':(1,slice(9,14)),
                                'top_7':(2,slice(9,14)),
                                'top_8':(3,slice(9,14)),
                                ...
                                'bottom_9':(4,slice(14,19)),
                                'bottom_10':(5,slice(14,19)),
                                'away_runs_0':(6,slice(14,19)),
                                'away_runs_1':(7,slice(14,19)),
                                'first_base':(0,19),
                                'second_base':(1,19),
                                'third_base':(2,19),
                                'ball_one':(3,19),
    ...
    def toggle_mux(self,row: int, state: bool, all=False):
        self.lock.acquire()
        if all==False:
            self.values[row,0]
        else:
